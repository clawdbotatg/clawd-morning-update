...
- **clawd-daily** (checked out *beside* this repo — `render-paper.js` resolves
  ...
  (`YYYY-MM-DD.html`), `index.html` (same page as the newest edition),
  `og/<date>.png` unfurl cards, banner images, `days.json`, favicon/pfp.
...
## Daily flow (inside report.sh, 8:20am Denver)
